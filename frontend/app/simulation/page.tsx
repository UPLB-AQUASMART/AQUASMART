...
function IdwNav() {
  return (
    <header className="idw-nav" aria-label="AQUASMART Mini navigation">
      <Link className="idw-nav-logo" href="/#home" aria-label="AQUASMART Mini home">
        <img src="/assets/logo_2.png" alt="AQUASMART Mini" />
      </Link>
      <nav className="idw-nav-links" aria-label="Primary navigation">
        {navLinks.map((link) => (
...
export default function SimulationPage() {
  return (
    <main className="idw-page">
      <IdwNav />

      <section className="idw-map-hero">
        <img className="idw-map-image" src="/figma/idw-map.png" alt="" />
        <div className="idw-map-content">
          <h1>
            Spatial Drawdown
            <span>Map</span>
          </h1>
          <div className="idw-map-bottom">
            <p>{heroCopy}</p>
            <a className="idw-view-button" href="#idw-info" aria-label="View IDW explanation">
      ...
      <div className="idw-navy-spacer" aria-hidden="true" />
      <SiteFooter />
    </main>
  );
}
