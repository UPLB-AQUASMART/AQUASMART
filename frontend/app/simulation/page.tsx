    ...
    <main className={styles["idw-page"]}>
      ...
      <section className={styles["idw-info-section"]} id="idw-info">
        ...
        <div className={styles["idw-info-row"]}>
          <img
            src="/figma/idw-surface.png"
            alt="Interpolated IDW surface with measured points"
          />
          <p>{longCopy}</p>
        </div>
      </section>
      ...
      <section className={styles["idw-drawdown-section"]}>
        ...
        <div className={styles["idw-drawdown-images"]}>
          <img
            src="/figma/idw-drawdown-well.png"
            alt="Well drawdown cone of depression diagram"
          />
          <img
            src="/figma/idw-aquifer-pumping.png"
            alt="Water-table drawdown and recovery after pumping diagram"
          />
        </div>
        <p>{drawdownCopy}</p>
      </section>
